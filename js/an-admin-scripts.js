...
jQuery(document).ready(function ($) {
    ...
    if (an_admin.pro !== 'yes') {
        if ($('#an-only-pro-area').length === 0) {
            $('#advanced-options, #exclusions').append('<a id="an-only-pro-area" href="' + an_admin.pro_url + '" title="Buy Adblock Notify PRO" target="_blank" class="pro-badge">Only Pro</a>');
        }
        $('#adblocker_notify_an_option_modal_after_pages, #adblocker_notify_an_option_modal_width').parent().find('.number-slider').off();
        $('#adblocker_notify_an_option_modal_after_pages, #adblocker_notify_an_option_modal_width, #adblocker_notify_an_option_modal_dismiss, #adblocker_notify_an_option_exclusion_type, .an_exclude_div').css({
            'cursor': 'not-allowed',
            'pointer-events': 'none'
        });
        $('#adblocker_notify_an_option_modal_after_pages, #adblocker_notify_an_option_modal_width, #adblocker_notify_an_option_modal_dismiss, #adblocker_notify_an_option_exclusion_type, .an_exclude_div').parent().css({
            'cursor': 'not-allowed',
            'pointer-events': 'none'
        });
        $('#adblocker_notify_an_option_modal_after_pages, #adblocker_notify_an_option_modal_width, #adblocker_notify_an_option_modal_dismiss, #adblocker_notify_an_option_exclusion_type, .an_exclude_div').attr('disabled', 'disabled');

        $('.an_exclude_div *').attr('disabled', 'disabled');
    }
